...
export class NFTStorage implements Service {
     ...
     * @returns {Promise<CIDString>}
     */
    static storeCar({ endpoint, token, rateLimiter }: Service, car: Blob | CarReader, { onStoredChunk, maxRetries, decoders, signal }?: import("./lib/interface.js").CarStorerOptions | undefined): Promise<CIDString>;
    /**
     ...
     */
    static status({ endpoint, token, rateLimiter }: Service, cid: string, options?: import("./lib/interface.js").RequestOptions | undefined): Promise<import('./lib/interface.js').StatusResult>;
    /**
     ...
     */
    static delete({ endpoint, token, rateLimiter }: Service, cid: string, options?: import("./lib/interface.js").RequestOptions | undefined): Promise<void>;
    /**
